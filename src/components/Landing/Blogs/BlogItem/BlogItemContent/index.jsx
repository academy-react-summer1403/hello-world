      ...
      >
        <div className="left w-[62%] h-[161px] ">
          ...
          <div className="bottom w-[100%]  h-[20%] flex justify-start pr-2 flex-row-reverse   ">
            <div
              dir="rtl"
              className="Data1 w-[18%] h-[100%] flex gap-1 mr-2 text-[12px] font-bold justify-start pt-[8.5px] max-sm:w-[50%]   "
            >
            ...
            <div
              dir="rtl"
              className="Data2 w-[20%] h-[100%] flex gap-1 text-[12px] font-bold  pt-[8.5px]  "
            >
