  ...
  return (
    ...
    >
      ...
      <div className=" w-[97%] h-[38%] flex justify-end flex-wrap pt-4">
        <div className="date w-[100px] h-[40px] dark:bg-[#111827] bg-[#DAEEFF] rounded-[80px] bg-no-repeat bg-[center_right_1rem] text-right text-[13px] font-bold text-[#2196F3] pr-9 pt-[13px] relative">
          <img className="absolute right-[15px] top-[14px]" src={calendar}   />
        <span>  {insertDate && ConvertToPersianDate(insertDate)   } </span>
        </div>
        <div className="view w-[100px] h-[40px] dark:bg-[#111827] bg-[#DAEEFF] rounded-[80px] ml-3  text-right text-[13px] font-bold text-[#2196F3] pr-9   relative">
        ...
        <h2 dir="rtl" className=" dark:text-white w-full text-[#263238] text-[20px] text-right  font-medium font-[YekanBakhBold]">  {title} </h2>
        <h4 dir="rtl" className=" dark:text-white w-full text-[#455A64] text-[12px] text-right font-medium font-[YekanBakh]">
          {miniDescribe}
