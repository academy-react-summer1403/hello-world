    ...
    <div className="w-full flex justify-center mt-10 mb-20">
      <div className="categories flex  mt-20 w-[1410px] h-[752px]  relative max-dd:hidden ">
        ...
        <div className="item flex    w-[688px] h-[752px]  z-50   absolute  left-[80px] top-0  ">
          <div className="it1 flex justify-center items-center py-10 flex-wrap  border-[#eeeeee] border-[1px] border-solid max-xl:w-[270px] max-xl:h-[270px]  max-lgx:w-[240px] max-lgx:h-[240px]  w-[300px] h-[300px] rounded-3xl   absolute  left-0 top-[80px] bg-[#ffffff]     ">
            <div className="icon1   w-[80px]  h-[80px]  max-lgx:top-[33px] ">
              <img src={pic6} alt="image" />{" "}
            </div>
            <h1 className="text-gray3 w-full  text-center text-[24px] font-[YekanBakhBold] leading-[50px]  max-lgx:text-[19px]">
              {" "}
              بازی
            </h1>
            <p className="text-gray4   text-center w-[200px] text-[13px] font-[YekanBakh] max-lgx:text-[11px] ">
              {" "}
              بعد از اتمام آموزش، به شرکت‌ها و سرمایه‌گذاران بازی‌ساز معرفی خواهی شد
            </p>
          </div>

          <div className="it2 flex justify-center items-center py-10 flex-wrap border-[#eeeeee] border-[1px] border-solid max-xl:w-[270px] max-xl:h-[270px]   max-lgx:w-[240px] max-lgx:h-[240px]  w-[300px] h-[300px] rounded-3xl   absolute max-xl:right-10 max-lgx:right-36 max-lgx:top-10 right-0 top-[10px]  bg-white   ">
            <div className="icon2  w-[80px]  h-[80px] ">
              <img src={pic7} alt="image" />{" "}
            </div>
            <h1 className="text-gray3 w-full text-center text-3xl text-[24px] font-[YekanBakhBold] leading-[50px]  max-lgx:text-[19px]    ">
              تحلیل داده
            </h1>
            <p className="text-gray4  text-center  w-[200px] text-[13px] font-[YekanBakh]  max-lgx:text-[11px] ">
              {" "}
          ...
          <div className="it3 flex justify-center items-center py-10 flex-wrap border-[#eeeeee] border-[1px] border-solid max-xl:w-[270px] max-xl:h-[270px] max-lgx:w-[240px] max-lgx:h-[240px]   w-[300px] h-[300px] rounded-3xl   absolute max-xl:right-10 max-xl:top-[370px]  max-lgx:right-36 max-lgx:top-[320px] right-0 top-[370px]  bg-white  ">
            <div className="icon2  w-[80px]  h-[80px] ">
          ...
          <div className="it4 flex justify-center items-center py-10 flex-wrap border-[#eeeeee] border-[1px] border-solid max-xl:w-[270px] max-xl:h-[270px]  max-lgx:w-[240px] max-lgx:h-[240px]  w-[300px] h-[300px] rounded-3xl   absolute  max-xl:top-[420px] max-lgx:top-[370px] left-0 bottom-[10px] bg-white  ">
            <div className="icon2  w-[80px]  h-[80px] ">
