...
function Titr() {
  return (
    <div className="Titr w-[100%] h-[30%] mt-5 flex justify-center flex-wrap">
      ...
      <h1 className="w-full ProjectFontBold font-[2000] h-[40%] flex justify-center mt-[35px] mb-[0px] max-short:h-[0%] text-[#263238] leading-[70px] text-[68px] max-xl:text-[60px] max-md:text-[57px] max-sm:text-[50px] max-mini:text-[43px] max-short:text-[34px] max-short:leading-[22px]">
