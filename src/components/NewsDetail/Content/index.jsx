    ...
    <div className="bg-white2 dark:bg-[#1a1a2e]">
      <div className="  flex justify-center  ">
        <div className="w-[60%] mt-[25px]">
          <h1 dir="rtl" className='text-right  font-["YekanBakhBold"] text-[30px] text-grayy max-mini1:text-[15px] dark:text-white'>
            {" "}
            {props?.googleTitle}
          </h1>
          <p dir="rtl" className='text-right  font-["YekanBakh"] text-[15px] text-gray4 max-mini1:text-[10px] max-mini1:leading-[20px]  leading-[40px] dark:text-white '>
            {props?.describe}
          </p>
        </div>
      </div>
      ...
      <div className="h-12 flex justify-center  items-center gap-32 mt-3">
        <div className=" flex w-[361px] h-12 justify-end items-center gap-2">
          <div className="flex justify-end items-center gap-4">
            <div className="flex justify-center items-center w-20 h-11 rounded-3xl bg-slate-100">
              <span className="text-xl text-gray4">{props?.currentDissLikeCount && faNumber(props?.currentDissLikeCount.toString(), ",")}</span>
              <AiOutlineDislike className="w-6 h-6 ml-2" />
            </div>
            <div className="flex justify-center items-center w-20 h-11 rounded-3xl bg-slate-100">
              <span className="text-xl text-gray4">{props?.currentLikeCount && faNumber(props?.currentLikeCount.toString(), ",")}</span>
              <AiOutlineLike className="w-6 h-6 ml-2" />
            </div>
          </div>
          <span className="dark:text-white text-gray4 max-md:text-[10px] max-md:whitespace-nowrap">آیا از این مقاله راضی بودید؟</span>
        </div>
        <div className=" flex justify-start items-center flex-nowrap flex-row-reverse gap-4 w-80 h-8 max-min:hidden ">
          ...
          <div>
            <span className="text-xs dark:text-white  max-md:text-[10px] max-md:whitespace-nowrap">امتیاز 20 نفر</span>
          </div>
