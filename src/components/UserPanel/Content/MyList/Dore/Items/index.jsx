...
const Items = ({tumbImageAddress,courseTitle,termName,paymentStatus,fullName,cost,courseId}) => {
  ...
  return (
    <div className="w-[100%] h-[55px] hover:bg-[#e5e0ff] transition-[0.1s] rounded-[7px] mb-2 flex justify-center flex-wrap">
      ...
      <button onClick={handleOpen} className="w-[27px] h-full flex justify-center">
