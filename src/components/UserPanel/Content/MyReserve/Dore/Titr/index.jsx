...
const Titr = () => {
  return (
    <div className="w-[100%] h-[55px] bg-[#3f40ea] rounded-[7px] mb-3 flex justify-center flex-wrap">
      ...
      <div className="w-1/6 h-full text-[#fffeff] text-center pt-[17px] pr-16">
        قیمت{" "}
      </div>
      <div className="w-1/6 h-full text-[#fffeff] text-center pr-24 pt-[17px]">
        وضعیت
      </div>
      <div className="w-1/6 h-full text-[#fffeff] text-center pr-12 pt-[17px]">
        {" "}
        مدرس
      </div>
