  ...
  return (
    <div className="dv1 flex justify-end flex-wrap  w-[50%]  h-[600] ">
      ...
      <div className="  h-[150px]">
        <h3
          dir="rtl"
          className=" font-[YekanBakhBold] text-right text-[24px] text-grayy leading-[70px] max-md:text-[20px] max-short:text-[10px] "
        >
          {props?.title}
        </h3>
        <p
          dir="rtl"
          className="font-[YekanBakh] text-right text-[15px] text-gray2 leading-[20px] max-md:text-[12px]  "
        >
          {props?.miniDescribe}{" "}
        </p>
      </div>
